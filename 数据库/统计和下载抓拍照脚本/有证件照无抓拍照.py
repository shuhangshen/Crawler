...
import cx_Oracle
f1 = open(r'E:\省有抓拍统计.txt', 'w', encoding='utf-8')
f2 = open(r'E:\市有抓拍统计.txt', 'w', encoding='utf-8')
f3 = open(r'E:\区有抓拍统计.txt', 'w', encoding='utf-8')
    ...
    for j in range(1, 99):
        ...
        for k in range(1, 99):
            if k < 10:
                ...
                qu = str(k)
            sql = 'SELECT DB_ID FROM PERSON_TOTAL_TABLE WHERE ORIGIN_ID LIKE \'%s%s%s___________\' ' % (
                shengfen, shi, qu)
