...
class BaiduimageSpider(scrapy.Spider):
    ...
    keywords_file = r'C:\Users\YJY\Desktop\carpicture\keywords.txt'
    ...
    def __init__(self):
        ...
        self.log_file = open(r'C:\Users\YJY\Desktop\carpicture\log.txt', 'w', encoding='utf-8')
        print("init end")
